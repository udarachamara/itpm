        ...
        <div  class="w3-main" style="margin-left:250px">
            ...
            <div class="w3-row w3-padding-64 w3-padding-small">
                <div class="w3-twothird w3-container w3-padding-large">
                    ...
                    <%retBook p = new retBook();%>
                    <%String id, isbn, memberId, borrowedDate;%> 
                    <% double amount; %>
                    <% ResultSet rs = p.getreturnList();%>
                    ...
                    <%borrowedDate = rs.getString("borrowedDate");%>
                    
                    <% amount = p.getDelayAmount(memberId,isbn);%>

                    <div class="w3-rest w3-container w3-border w3-padding-large">

                        <form method="post" action="returnBook" class="w3-center" style="align-items: center; " onsubmit="return confirm('Are you sure  want to Return This Book?')">

                            <p style="text-align: left" class=" w3-padding-small " id="id">ISBN : <%=isbn%> </p>
                            <p style="text-align: left" class=" w3-padding-small " id="memberid">Member : <%=memberId%> </p>
                            <p style="text-align: left" class=" w3-padding-small " id="bdate">Borrowed Date : <%=borrowedDate%> </p>
                            <p style="text-align: left" class=" w3-padding-small " id="amount">Amount : <%=amount %> </p>
                            ...
                            <input type="hidden" name="bdate" value="<%=borrowedDate%>">

                            <p ><button class="w3-button  w3-gray w3-center " style="width: 200px; float: right; margin: 10px " type="submit" >Return Book</button></p>
                        </form>
